...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 3BladesApi.EnvType();
  });
  ...
  describe('EnvType', function() {
    it('should create an instance of EnvType', function() {
      // uncomment below and update the code to test EnvType
      //var instane = new 3BladesApi.EnvType();
      //expect(instance).to.be.a(3BladesApi.EnvType);
    });

    it('should have the property envTypeId (base name: "envTypeId")', function() {
      // uncomment below and update the code to test the property envTypeId
      //var instane = new 3BladesApi.EnvType();
