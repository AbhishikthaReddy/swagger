...
(function(root, factory) {
  ...
  describe('Job', function() {
    it('should create an instance of Job', function() {
      ...
      //var instane = new 3BladesApi.Job();
      //expect(instance).to.be.a(3BladesApi.Job);
    });
    ...
    it('should have the property autoRestart (base name: "auto_restart")', function() {
