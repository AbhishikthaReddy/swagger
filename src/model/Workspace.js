...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EnvType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EnvType'));
  } else {
    // Browser globals (root is window)
    if (!root.3BladesApi) {
      root.3BladesApi = {};
    }
    root.3BladesApi.Workspace = factory(root.3BladesApi.ApiClient, root.3BladesApi.EnvType);
  }
}(this, function(ApiClient, EnvType) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resourcesId')) {
        obj['resourcesId'] = ApiClient.convertToType(data['resourcesId'], 'String');
      }
    }
    return obj;
  }
